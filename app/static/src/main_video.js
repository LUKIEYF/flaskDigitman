...
$(document).ready(function(){
    // modelInstance.getLive2dModel().getModel().motion("Tap");
    ...
    //                     h += '<div class="pause">';
    //                     h += '<img src="../static/images/play_s.png" alt="" width="28">';
    //                     h += '</div>';
    ...
    //                     h += '<img src="../static/images/sound_l.png" alt="" width="16">';
    //                     h += '</div>';
    ...
    //                     if (video.paused) {
    //                         $(e).find('.play').hide();
    //                         $(e).find('.pause').children('img').prop('src', '..static/images/pause_s.png');
    //                         video.play();
    //                         option.whenPlay();
    //                     } else {
    //                         $(e).find('.play').show();
    //                         $(e).find('.pause').children('img').prop('src', '..static/images/play_s.png');
    //                         video.pause();
    //                     }
    //                 },
    ...
    // $('#video-wrap').createVideo({
    //     url: '../static/video/test.mp4'
    // });

    // window.onload = async ()=>{
    //     await modelInstance.createLive2dModel();
    //     modelInstance.chatAndSpeech("Welcome to the digital man prototype testing and hope you enjoy this experience!")
    // };
    
    // modelInstance.getLive2dModel().getModel().on("hit", (hitAreas) => {
